...
package com.emuneee.nctrafficcams.common.util;
...
public abstract class ImageWorker {
	...
	private static final int FADE_IN_TIME = 125;
	 ...
	 */
	public void loadImage(String data, ImageView imageView, Camera camera) {
		Bitmap bitmap = null;
		...
		if (bitmap != null) {
			...
			final BitmapWorkerTask task = new BitmapWorkerTask(imageView, camera);
	...
	private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
		...
		public BitmapWorkerTask(ImageView imageView, Camera camera) {
		...
		protected Bitmap doInBackground(Object... params) {
			...
			if (bitmap == null && !isCancelled()
					&& getAttachedImageView() != null && !mExitTasksEarly) {
				bitmap = HttpUtils.getBitmapFromNetwork(dataString);
				mCamera.setUpdated(Calendar.getInstance().getTimeInMillis());
				MainActivity.getDBHelper().updateTrafficCamera(mCamera);
			}
